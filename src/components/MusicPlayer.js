...
import { FaRegHeart, FaHeart, FaStepBackward, FaBackward, FaShareAlt, FaPlay, FaPause, FaForward, FaStepForward } from 'react-icons/fa';
...
function MusicPlayer({song, imgSrc}) {
    ...
    const changeCurrentTime = () => {
        ...
        `${(progressBar.current.value / duaration) *100}%`);
        ...
        <div className='songAttributes'>
            ...
            <div className='bottom'>
                ...
                <div className='duaration'>
                    {(duaration && !isNaN(duaration) && calculateTime(duaration)) ?
                    calculateTime(duaration): '00:00'}
                    </div>
            </div>
        </div>
    </div>
